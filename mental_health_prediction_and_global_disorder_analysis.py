# -*- coding: utf-8 -*-
"""Mental Health Prediction and Global Disorder Analysis.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AquK2MhzBHtZaZ3fctFxJMcUdYEl3adU
...
# Correct renderer for Google Colab
pio.renderers.default = 'colab'

# Sort data
df2 = df2.sort_values(by="Major depression", ascending=True)
...
fig = px.bar(
    ...
    title="Major Depression vs Entities"
)

fig.show()

# Ensure correct renderer for Google Colab
pio.renderers.default = 'colab'

# Sort the data
df2 = df2.sort_values(by="Eating disorders", ascending=True)
...
fig = px.bar(
    ...
    orientation='h',
    color="Dysthymia",
    title="Eating Disorders Across Entities"
)
...
# Ensure Plotly works in Google Colab
pio.renderers.default = 'colab'

# Sort by Schizophrenia values
df2 = df2.sort_values(by="Schizophrenia", ascending=True)
...
fig = px.bar(
    ...
    title="Schizophrenia Levels Across Entities"
)
...
# Ensure correct renderer for Colab
pio.renderers.default = 'colab'
...
# Regions list
x1 = [
    "Andean Latin America", "West Sub-Saharan Africa", "Tropical Latin America", "Central Asia",
    "Central Europe", "Central Sub-Saharan Africa", "Southern Latin America",
    "North Africa/Middle East", "Southern Sub-Saharan Africa", "Southeast Asia",
    "Oceania", "Central Latin America", "Eastern Europe", "South Asia",
    "East Sub-Saharan Africa", "Western Europe", "World", "East Asia",
    "Caribbean", "Asia Pacific", "Australasia", "North America"
]
...
# X-axis labels
x = [
    "Appetite change", "Average across symptoms", "Depressed mood",
    "Difficulty concentrating", "Loss of interest", "Low energy",
    "Low self-esteem", "Psychomotor agitation", "Psychomotor agitation",
    "Sleep problems", "Suicidal ideation"
]
...
fig.add_trace(go.Scatter(
    x=x,
    y=df4["Number of countries with primary data on prevalence of mental disorders"],
...
"""the maximum regression accuracy for this model was almost 70%."""